                                ...
                                {posts.map((post, idx) => (
                                    ...
                                    >
                                        <Link href={`/blog/${post.slug.current}`}>
                                            ...
                                            <h3 className="text-2xl font-bold mb-4 group-hover:text-primary transition-colors leading-tight text-white">
                                                {post.title}
                                            </h3>
                                            {post.excerpt && (
                                                <p className="text-gray-400 mb-6 line-clamp-2 italic">
                                                    {post.excerpt}
                                                </p>
                                            )}

                                            <span className="inline-flex items-center gap-2 font-bold text-white group-hover:gap-4 transition-all group-hover:text-primary">
